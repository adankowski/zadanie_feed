...
class ApplicationTests {
    ...
    public void setUp() {
        ...
        Mockito.when(socketService.getUnifeedCollection()).thenReturn(unifeedCollection);
    }
    ...
    void contextLoads() {
        ...
        List<Unifeed> unifeedCollection = new ArrayList<>(socketService.getUnifeedCollection());
